...
def parse_args():
    ...
    parser.add_argument("--api_key", default="sk-N69BpwpNpLLKBDhQ5f1dE5Dd10844c8fA355709d2f899076", help="OpenAI API key.")
    parser.add_argument("--api_base", default="https://www.plus7.plus/v1", type=str, help="OpenAI API base.")
