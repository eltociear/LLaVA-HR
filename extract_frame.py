...
def fetch_images_parallel(qa_item):
    ...
    print(image_id)
    if not os.path.exists(os.path.join(image_dir, f"{image_id}_0.png")):
        # print(qa_item)
...
if __name__ == "__main__":
    root='/data/luogen_code/LLaVA-robust/playground/data/eval/Activitynet_Zero_Shot_QA/all_test'
    video_img_dir = '/data/luogen_code/LLaVA-robust/playground/data/eval/Activitynet_Zero_Shot_QA/images'
    qa_items=[]
